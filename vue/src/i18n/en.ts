...
You can specify which snapshot to restore to when starting IIB in the global settings page, or restore to the last workspace state before closing.`,
  ...
  revealWithLocalFileBrowser: 'Reveal in Local File Browser',
  remoteMountRevealedViaAgent: 'Revealed in Finder',
  ...
  copiedWorkflow: 'Workflow copied to clipboard',
  noWorkflowFound: 'No embedded workflow found in this image',
